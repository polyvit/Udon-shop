...
import { setSearchValue } from '../../features/filters/filter-slice';
...
const Search = () => {
  ...
  return (
    <div style={{position: "relative"}}>
              <svg className={styles.icon} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"  xmlSpace="preserve">
